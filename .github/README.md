...
[`@aws-sdk/client-cloudfront`](https://www.npmjs.com/package/@aws-sdk/client-cloudfront/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Rm8vFGzbkaU1sQ/d8FrR1bCV0KtDwnY2nbZZGp0CDl78+w3DTdoExysRFQVAemh3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudfront": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.934.0/index.min.mjs": "sha384-Rm8vFGzbkaU1sQ/d8FrR1bCV0KtDwnY2nbZZGp0CDl78+w3DTdoExysRFQVAemh3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudfront/blob/refs/tags/3.934.0/LICENSE
```
