...
[`@aws-sdk/client-cloudfront`](https://www.npmjs.com/package/@aws-sdk/client-cloudfront/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E72TckdNy+jKZSyXdtMO0Kw0mapZU2KEXhJUlko5if9BQDAZLRhQNFImFW+s3t5Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudfront": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.932.0/index.min.mjs": "sha384-E72TckdNy+jKZSyXdtMO0Kw0mapZU2KEXhJUlko5if9BQDAZLRhQNFImFW+s3t5Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudfront/blob/refs/tags/3.932.0/LICENSE
```
