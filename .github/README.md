...
[`@aws-sdk/client-cloudfront`](https://www.npmjs.com/package/@aws-sdk/client-cloudfront/v/3.408.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.408.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/dXD6Nr2bLQ0LPsp07O1ISPV8pIaFr+PDWsnw6kCaIN6jAPi/XzvGDvNvrTAtFwN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudfront": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.408.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.408.0/index.min.mjs": "sha384-/dXD6Nr2bLQ0LPsp07O1ISPV8pIaFr+PDWsnw6kCaIN6jAPi/XzvGDvNvrTAtFwN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudfront/blob/refs/tags/3.408.0/LICENSE
```
