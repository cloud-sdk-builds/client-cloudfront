...
[`@aws-sdk/client-cloudfront`](https://www.npmjs.com/package/@aws-sdk/client-cloudfront/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PQn63RMcflnd/mKEdL8+9nfaRZNSuDSKIeDxDdP1cTrC3ZCyu85neGMzLUeqMHzH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudfront": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudfront@3.798.0/index.min.mjs": "sha384-PQn63RMcflnd/mKEdL8+9nfaRZNSuDSKIeDxDdP1cTrC3ZCyu85neGMzLUeqMHzH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudfront/blob/refs/tags/3.798.0/LICENSE
```
